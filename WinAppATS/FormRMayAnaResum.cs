...
namespace WinAppATS
{
    public partial class FormRMayAnaResum : Form
    {
        public FormRMayAnaResum()
        {
            InitializeComponent();
        }

        private void FormRMayAnaResum_Load(object sender, EventArgs e)
        {
        ...
        private async void reporte()
        {
            ...
            if (data.Tables.Count > 0)
            {
                ...
                this.reportViewer1.LocalReport.DisplayName = "RESUMEN MAYOR ANALITICO";
                this.reportViewer1.LocalReport.ReportPath = Const.filereport("RMayAnaResum");
