...
namespace WinAppATS
{
    public partial class FormRMayAnaDetal : Form
    {
        public FormRMayAnaDetal()
        {
            InitializeComponent();
        }

        private void FormRMayAnaDetal_Load(object sender, EventArgs e)
        {
        ...
        private async void reporte()
        {
            ...
            if (data.Tables.Count > 0)
            {
                ...
                this.reportViewer1.Location = new System.Drawing.Point(10, 40);
