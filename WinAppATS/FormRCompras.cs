...
namespace WinAppATS
{
    public partial class FormRCompras : Form
    {
        public FormRCompras()
        {
            InitializeComponent();
        ...
        private void FormRCompras_Load(object sender, EventArgs e)
        {
        ...
        private async void reporte()
        {
            ...
            if (data.Tables.Count > 0)
            {
                ...
                this.reportViewer1.LocalReport.DisplayName = "LISTA DE TODAS LAS COMPRAS";
                this.reportViewer1.LocalReport.ReportPath = Const.filereport("RCompras");
